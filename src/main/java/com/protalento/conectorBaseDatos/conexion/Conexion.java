package com.protalento.conectorBaseDatos.conexion;

import com.protalento.conectorBaseDatos.enumerados.Base_64;
import com.protalento.conectorBaseDatos.utilidades.Esquema_Base64;
...
public final class Conexion {
   ...
   private static final InputStream  PATH = Thread.currentThread().getContextClassLoader().getResourceAsStream("database.properties"); //esto me permite acceder directamente y cargar el archivo properties
    ...
    public  Connection conexiondb(){
        ...
        Properties properties = new Properties();  // se crea una instancia de la clase propertirs para acceder a sus metodos
        try {
